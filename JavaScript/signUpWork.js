...
function handleSelectClick(type) {
    ...
    if (selectedValue === "other") {
        htmlPrint = `<div><input type="text" class="typing" placeholder="Number" id="${type}-inserts"></div>`;
        ...
        for(let i = 0; i < 3; i++){
        htmlPrint = `<div><input type="text" placeholder="Institution" id="${type}-inserts"></div><div><input type="text" placeholder="Institution" class="typing" id="${type}-inserts"></div><div><input type="text" class="typing"  
        placeholder="Institution" id="${type}-inserts"></div>`;
        document.querySelector(`.${type}-output`).innerHTML = htmlPrint;
        }
    }
    ...
    if ((type === "institution") && (selectedValue === "1" || selectedValue === "2" || selectedValue === "3")) {
        ...
        for (let i = 0; i < numInserts; i++) {
            ...
            <input type="text" placeholder="Institution" class="typing" id="${type}-inserts">
